...
public enum ControllerMessageType {
	...
	protected static final Map<Integer, ControllerMessageType> enumMap = new TreeMap<Integer, ControllerMessageType>();

	static {
		ControllerMessageType[] values = ControllerMessageType.values();
		ControllerMessageType value;
	...
	private ControllerMessageType(int id, String label) {
		this.id = id;
		this.label = label;
	}
